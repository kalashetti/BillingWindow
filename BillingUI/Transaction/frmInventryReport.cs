...
namespace AC.Billing.UI.Transaction
{
    public partial class frmInventryReport : BaseClass
    {
        ...
        public string GenerateHtml(DataTable dt, string CustomerName, string InvoiceNo, string MobileNo, string InvoicePrintDate, string BillingAddress, string ShipingAddress, string Remarks1)
        {
            ...
            html.Append("<title>Inventory Report</title>");
            ...
            html.Append("<td class=\"auto-style5\"><strong>Inventory Report</strong></td>");
            html.Append("</tr>");
            html.Append("<tr>");
            html.Append("<td class=\"auto-style3\" colspan=\"2\">");
            ...
            html.Append("<td class=\"auto-style13\" style=\"vertical-align:middle;\">Company</td>");
            ...
            foreach (DataRow dr in dt.Rows)
            {
                ...
                html.Append("<td class=\"auto-style13\" style=\"vertical-align:middle;\">");
                html.Append(dr["CompanyName"].ToString());
                html.Append("</td>");
                ...
                html.Append("<td class=\"auto-style13\" style=\"vertical-align:middle;\">");
                html.Append(Convert.ToDateTime(dr["InventoryDate"].ToString()).ToString("MM-dd-yy"));
                html.Append("</td>");
