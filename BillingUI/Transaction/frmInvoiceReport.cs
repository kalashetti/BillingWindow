...
namespace AC.Billing.UI.Transaction
{
    public partial class frmInvoiceReport :BaseClass
    {
        ...
        public string GenerateHtml(DataTable dt, string CustomerName, string InvoiceNo, string MobileNo, string InvoicePrintDate, string BillingAddress, string ShipingAddress, string Remarks1)
        {
            ...
            html.Append("<title>Invoice Report</title>");
            ...
            html.Append("<td class=\"auto-style5\"><strong>Invoice Report</strong></td>");
            html.Append("</tr>");
            html.Append("<tr>");
            html.Append("<td class=\"auto-style3\" colspan=\"2\">");
            ...
            html.Append("\"width: 100 %;border-left:solid;border-top:solid;border-bottom:solid;border-right:solid;\"");
            html.Append("<tr>");
            html.Append("<td class=\"auto-style17\" style=\"vertical-align:middle;\">Invoice </td>"); 
            html.Append("<td class=\"auto-style13\" style=\"vertical-align:middle;\">Customer</td>");
            html.Append("<td class=\"auto-style17\" style=\"vertical-align:middle;\">Contact </td>");   
            //html.Append("<td class=\"auto-style18\">");  //GST
            //html.Append("<br />");
            //html.Append("</td>"); //Rate 
            html.Append("<td class=\"auto-style17\" style=\"vertical-align:middle;\">Email </td>");         
            //html.Append("<td class=\"auto - style22\"></td>");  //per
            html.Append("<td class=\"auto-style17\" style=\"vertical-align:middle;\">Paid</td>");
            html.Append("<td class=\"auto-style17\" style=\"vertical-align:middle;\">Credit</td>");
            ...
            foreach (DataRow dr in dt.Rows)
            {
                ...
                html.Append("<td class=\"auto-style13\" style=\"vertical-align:middle;\">");
                html.Append(dr["ContactNumber"].ToString());
                html.Append("</td>");


                html.Append("<td class=\"auto-style13\" style=\"vertical-align:middle;\">");
                html.Append(dr["Email"].ToString());
                html.Append("</td>");



                html.Append("<td class=\"auto-style13\" style=\"vertical-align:middle;\">");
                html.Append(dr["IsPaid"].ToString());
                html.Append("</td>");


                html.Append("<td class=\"auto-style13\" style=\"vertical-align:middle;\">");
                html.Append(dr["IsOnCredit"].ToString());
                html.Append("</td>");



                html.Append("<td class=\"auto-style13\" style=\"vertical-align:middle;\">");
                html.Append(Convert.ToDateTime(dr["InvoiceDate"].ToString()).ToString("MM-dd-yy"));
                html.Append("</td>");
        ...
        private string FillDataGridForPrint()
        {
            ...
            dTable = invoiceBLL.GetInvoiceMonthlyReport(Convert.ToDateTime(txtStartDate.Text.Trim()), Convert.ToDateTime(txtEndDate.Text.Trim()));          
