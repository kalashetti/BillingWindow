...
namespace AC.Billing.UI.Transaction
{
    public partial class frmDeliveryNote : BaseClass
    {
        ...
        private string FillDataGridForPrint()
        {
			...
			//string Html = GenerateHtml((DataTable)PrintGrid.DataSource, CustomerNamePrint, InvoiceNo, MobileNo, InvoicePrintDate, BillingAddress, ShipingAddress, Remarks1);
			string Html = GenerateHtmlNew((DataTable)PrintGrid.DataSource, CustomerNamePrint, InvoiceNo, MobileNo, InvoicePrintDate, BillingAddress, ShipingAddress, Remarks1," ");
		...
		public string GenerateHtmlNew(DataTable dt, string CustomerName, string InvoiceNo, string MobileNo, string InvoicePrintDate, string BillingAddress, string ShipingAddress, string Remarks1, string CustomerGSTIN)
		{
			...
			html.Append("<td class=\"auto-style5\" style=\"text-align: center ;border-bottom: 1px solid \" colspan=\"3\"><strong>DELIVERY NOTE</strong></td>");
			html.Append("</tr>");
			html.Append("<tr>");
		...
		public string GenerateHtml(DataTable dt, string CustomerName, string InvoiceNo, string MobileNo, string InvoicePrintDate, string BillingAddress, string ShipingAddress, string Remarks1)
        {
            ...
            html.Append("<tr>");
            html.Append("<td class=\"auto-style3\" colspan=\"2\">");
            html.Append("<td class=\"auto-style5\"><strong>Invoice</strong></td>");
            html.Append("</tr>");
            html.Append("<tr>");
            html.Append("<td class=\"auto-style3\" colspan=\"2\">");
