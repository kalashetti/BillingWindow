...
namespace AC.Billing.UI.Transaction
{
    public partial class frmQuotationReport : BaseClass
    {
        ...
        public string GenerateHtml(DataTable dt, string CustomerName, string InvoiceNo, string MobileNo, string InvoicePrintDate, string BillingAddress, string ShipingAddress, string Remarks1)
        {
            ...
            html.Append("<title>Quotation Report</title>");
            ...
            html.Append("<td class=\"auto-style5\"><strong>Quotation Report</strong></td>");
            html.Append("</tr>");
            html.Append("<tr>");
            html.Append("<td class=\"auto-style3\" colspan=\"2\">");
            ...
            html.Append("<td class=\"auto-style17\" style=\"vertical-align:middle;\">Payment</td>");         
            ...
            foreach (DataRow dr in dt.Rows)
            {
                ...
                html.Append("<td class=\"auto-style13\" style=\"vertical-align:middle;\">");
                html.Append(dr["PaymentMode"].ToString());
                html.Append("</td>");


                html.Append("<td class=\"auto-style13\" style=\"vertical-align:middle;\">");              
                html.Append(Convert.ToDateTime(dr["QuotationDate"].ToString()).ToString("MM-dd-yy"));
                html.Append("</td>");
